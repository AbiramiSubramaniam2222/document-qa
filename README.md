...
```📁 Folder Structure
document-qa/
├── document_qa_demo.py     # Main script you run in VS Code
├── data/                   # Your local PDFs
...
The image is placed inside the `screenshots/` folder.   Please refer it for the demo output
